            ...
            <div class="row containerAssign">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="fomr-control">
                        <button class="btn btn-primary w-100 fv-bold assignProgram" disabled>Asignar programa</button>
                    </div>
                </div>
            </div>
            <div class="row">
...
$(document).ready( function ()
{
    ...
    $('#routes').select2({closeOnSelect: false,placeholder: "Seleccione las rutas..."});
...
function activateAssign()
{
    ...
    $('.assignProgram').attr('disabled',false)
}
function buildTable()
{
